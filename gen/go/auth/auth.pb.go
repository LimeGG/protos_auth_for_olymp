...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	AppOd    int32  `protobuf:"varint,3,opt,name=app_od,json=appOd,proto3" json:"app_od,omitempty"`
}
...
func (x *LoginRequest) GetAppOd() int32 {
	if x != nil {
		return x.AppOd
	}
	return 0
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x70, 0x70, 0x5f, 0x6f, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70,
	0x4f, 0x64, 0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x5a, 0x14, 0x6f, 0x6c, 0x79, 0x6d, 0x70, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x3b,
